...
//****************************************************************************************************************************//
    ...
    private void addRecipeToFirebase() {
        ...
        if (userId == null) {
            // User is not signed in, show an alert dialog
    ...
    private void showSignInAlertDialog() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Please sign in first to add a recipe.")
                .setPositiveButton("Sign In", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        // Redirect to sign-in activity
                        Intent intent = new Intent(add_recipe.this, login.class);
...
//
        ...
        // Save recipe data to "recipe" collection in Firestore
        db.collection("recipe")  // Update collection name to "recipe"
                .add(recipeData)
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    @Override
                    public void onSuccess(DocumentReference documentReference) {
